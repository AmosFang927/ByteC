...
| Hermes Agent | Nous Research's self-improving agent with closed learning loop |
...
- **Autonomous Skill Creation** — Creates skills after complex tasks
- **Self-Improving Skills** — Skills improve during use
- **Cross-Session Recall** — FTS5 session search with LLM summarization
- **User Modeling** — Honcho dialectic user modeling
- **Skills Hub** — Compatible with agentskills.io open standard

**Comparison:**

| Feature | Self-Improving Agent | Hermes Agent |
|---------|---------------------|--------------|
| **Learning Unit** | Instinct (atomic behavior) | Skill (complex capability) |
| **Scope** | Project vs Global | User-level persistent |
| **Creation** | Manual `/evolve` command | Autonomous after complex tasks |
| **Storage** | Markdown/YAML files | Database + FTS5 search |
| **User Model** | Implicit from instincts | Explicit Honcho dialectic |
| **Standard** | Internal format | agentskills.io compatible |

**Integration Ideas:**
1. **Autonomous Skill Creation** — Detect complex tasks and auto-trigger evolution
2. **FTS5 Search** — Add full-text search across all learnings
3. **User Modeling** — Build explicit user preference profiles
4. **Skills Hub** — Export/import skills via agentskills.io standard
